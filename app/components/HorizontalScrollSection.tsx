...
function TextoTitulo({
  ...
  return (
    <div className="text-left">
      <h3 className="font-title font-normal text-[110px] leading-[1.02] text-[#474C2C]">
        {collection}
      </h3>
      <h4 className="font-title font-normal text-[64px] leading-[1.05] text-[#474C2C] mt-[30px] mb-[30px]">
        {piece}
      </h4>
      <p className="font-content font-light text-[24px] leading-[1.55] text-[#474C2C]/90 max-w-[620px]">
        {description}
      </p>
    </div>
  );
  ...
  return (
    <div ref={containerRef} className="relative w-full bg-cream">
      ...
      >
        ...
        >
          {/* Panel 1 */}
          <section className="flex-shrink-0 w-screen h-full px-16">
            <div className="flex h-full items-center justify-between gap-20">
              ...
              <div className="flex flex-col gap-8">
                <div className="relative w-[800px] h-[430px]">
                  <Image
          ...
          {/* Panel 2 */}
          <section className="flex-shrink-0 w-screen h-full px-16">
            <div className="flex h-full items-start justify-between gap-20 pt-16">
              <div className="flex h-full flex-col justify-between pb-16">
                ...
                <div className="relative w-[550px] h-[430px]">
                  <Image
              ...
              <div className="relative w-[850px] h-[990px]">
                <Image
          ...
          <section className="flex-shrink-0 w-screen h-full px-16">
            <div className="flex h-full items-center justify-between gap-20">
              ...
              <div className="relative w-[950px] h-[630px]">
                <Image
          ...
          <section className="flex-shrink-0 w-screen h-full px-16">
            <div className="flex h-full items-center justify-between gap-20">
              <div className="relative w-[950px] h-[1000px]">
                <Image
          ...
          {/* Panel 6 */}
          <section className="flex-shrink-0 w-screen h-full px-16">
            <div className="flex h-full items-end justify-between gap-20 pb-16">
              <div className="relative w-[860px] h-[540px]">
                <Image
          ...
          {/* Panel 7 */}
          <section className="flex-shrink-0 w-screen h-full px-16 py-16">
